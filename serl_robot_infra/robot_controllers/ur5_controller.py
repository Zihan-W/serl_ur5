...
from ur_env.utils.serial_gripper import SerialGripper
...
class UrImpedanceController(threading.Thread):
    def __init__(
        ...
        self.serial_gripper: SerialGripper = None
        # self.robotiq_gripper: SerialGripper = None
    ...
    async def _update_robot_state(self):
        ...
        with self.lock:
            ...
            self.gripper_state[:] = [angle_pct, 0]
